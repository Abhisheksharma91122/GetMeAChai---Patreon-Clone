...
const Navbar = () => {
  ...
  return (
    <nav className='bg-gray-900 text-white w-full'>
      <div className='flex justify-between items-center px-4 md:h-16 py-4 md:py-0 gap-2 flex-row'>
        <div>
          <Link href={'/'}>
            <div className='logo font-bold text-xl flex justify-center items-center'>
              <Image className='invertImg' src="/tea.gif" alt="tea img" width={44} height={44} />
        ...
        <div className='relative'>
          ...
          <div id="dropdown" className={`z-10 ${showdropdown ? "" : "hidden"} absolute left-[15px] top-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-fit dark:bg-gray-700`}>
