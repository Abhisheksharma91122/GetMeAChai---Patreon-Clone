  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-6 h-[44vh] text-white px-4 md:px-0">
        <div className="font-bold sm:text-5xl text-2xl flex justify-center items-center">Buy Me a Chai <span><img className="invertImg" src="/tea.gif" alt="tea img" width={88} /></span></div>
