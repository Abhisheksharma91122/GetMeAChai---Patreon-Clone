  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-4 h-[44vh] text-white">
        <div className="font-bold text-5xl flex justify-center items-center">Buy Me a Chai <span><img className="invertImg" src="/tea.gif" alt="tea img" width={88} /></span></div>
